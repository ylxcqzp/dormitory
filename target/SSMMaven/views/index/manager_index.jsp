            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" class="site-url" data-title="请假审批" data-id="2" data-url="http://www.sina.com.cn">请假申请</a></dd>
                        <dd><a href="javascript:;" class="site-url" data-title="宿舍调整" data-id="3" data-url="http://www.sina.com.cn">宿舍调整</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item"><a href="javascript:;" class="site-url" data-title="保修处理" data-id="7" data-url="http://fly.layui.com/">保修处理</a></li>
            </ul>
        </div>
    </div>
